...
// MAGIC ### Step 4: Azure Security Integration
...
// MAGIC %md Issue file system commands (peak at blob storage - local or remote)
...
// MAGIC %md Data Scientist: I don't like Scala, I want to work in Python
...
// MAGIC %md Business User: I don't like python or Scala, but I love SQL
...
// MAGIC 
// MAGIC ### 3) Secure Enterprise-ready, Azure Native   
// MAGIC * Out of the box integraton with Active Directory, and RBAC controls  
